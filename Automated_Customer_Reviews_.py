...
model_name = "AbrarAlanazi/bert_customer_reviews"

model = BertForSequenceClassification.from_pretrained(model_name)  # Path where your model is saved
tokenizer = BertTokenizer.from_pretrained(model_name)  # Path where your tokenizer is saved
